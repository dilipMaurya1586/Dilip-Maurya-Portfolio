import { BriefcaseIcon, CodeBracketIcon, CpuChipIcon } from '@heroicons/react/24/outline';
...
export const experienceData = [
    {
        ...
        responsibilities: [
            "Built 10+ REST APIs for a production Hotel Booking Application, covering room search, booking management, cancellation, and user authentication.",
            "Designed relational database schemas and implemented input validation with proper error handling across all endpoints.",
