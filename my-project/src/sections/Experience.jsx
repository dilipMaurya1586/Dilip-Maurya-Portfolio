    ...
    return (
        <section id={id} className="">
            ...
            <div className=" px-5 sm:px-6 lg:px-8 py-20 md:py-16">
                ...
                {/* auto-fit grid: columns adjust automatically as more experience entries are
                    added, and justify-items-center keeps a single/odd entry centered instead
                    of stuck to the left. No layout code needs to change later. */}
                <motion.div
                    initial={{ opacity: 0 }}
                    whileInView={{ opacity: 1 }}
                    transition={{ staggerChildren: 0.1 }}
                    viewport={{ once: true, margin: "-100px" }}
                    className="grid gap-6 lg:gap-8 px-0 sm:px-5 lg:mx-10 justify-items-center grid-cols-[repeat(auto-fit,minmax(320px,1fr))]"
                >
