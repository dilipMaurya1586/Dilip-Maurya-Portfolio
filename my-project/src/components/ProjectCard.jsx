...
//               whileTap={{ scale: 0.95 }}
//               className="px-4 py-2 text-sm sm:text-base rounded-full text-center"
//               style={{ backgroundColor: 'white', color: selectedColor.value, border: `2px solid ${selectedColor.value}` }}
//             >
//               GitHub
//             </motion.a>
//           )}
...
//               whileTap={{ scale: 0.95 }}
//               className="px-4 py-2 text-sm sm:text-base rounded-full text-center"
//               style={{ backgroundColor: selectedColor.value, color: 'white', border: `2px solid ${selectedColor.value}` }}
//             >
//               Live Demo
//             </motion.a>
//           )}
